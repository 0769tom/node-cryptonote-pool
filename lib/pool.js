        ...
        case 'login':
            ...
            if(config.poolServer.fixedDiff.enabled) {
                ...
                if(fixedDiffCharPos != -1) {
                    ...
                    log('info', logSystem, 'Miner %s difficulty fixed to %s',  [login, difficulty]);
                }
            }
            ...
            miner = new Miner(minerId, params.login, params.pass, ip, difficulty, noRetarget, pushMessage);
